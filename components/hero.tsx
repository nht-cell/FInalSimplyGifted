          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16">
            {giftBaskets.map((basket) => (
              <div key={basket.id} className="group relative mx-2 sm:mx-0 cursor-pointer">
                <div className="relative overflow-hidden aspect-square border-0 border-black-200 rounded-lg transition-all duration-300 hover:border-accent hover:shadow-lg">
                  <img
